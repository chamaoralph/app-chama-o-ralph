import { ChevronLeft, ChevronRight, Clock, User, MapPin, Trash2, UserX } from 'lucide-react'
...
export function CalendarioCotacoesMensal({ cotacoes, onAprovar, onEditar, onExcluir }: CalendarioCotacoesMensalProps) {
