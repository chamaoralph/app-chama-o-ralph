-- Fix CSV import function to determine empresa_id server-side and validate admin role
-- This removes the p_empresa_id parameter completely and derives it from auth.uid()
