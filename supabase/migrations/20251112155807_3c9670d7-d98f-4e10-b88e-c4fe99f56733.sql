-- Criar função para gerar serviço automaticamente ao confirmar cotação
...
-- Criar trigger para executar a função após atualização
CREATE TRIGGER trigger_criar_servico
AFTER UPDATE ON cotacoes
FOR EACH ROW
EXECUTE FUNCTION criar_servico_ao_confirmar();