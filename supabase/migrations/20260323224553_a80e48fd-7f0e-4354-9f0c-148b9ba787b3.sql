...
BEGIN
  ...
  -- ============================================
  -- VERIFICAÇÃO 1: Cotação ativa (pendente ou aprovada) — qualquer data
  -- ============================================
  ...
  -- ============================================
  -- VERIFICAÇÃO 2: Serviço concluído/aguardando_aprovação nos últimos 3 dias
  -- ============================================
  ...
  -- ============================================
  -- VERIFICAÇÃO 3: Cotação criada nas últimas 48h (qualquer status) — mantém comportamento original
  -- ============================================
  SELECT c.id, c.created_at, c.status
