...
-- Fix valor_total calculation: don't add custo_suporte when empresa provides the bracket

-- 1. Fix criar_servico_ao_confirmar()
...
-- 2. Fix sincronizar_servico_ao_editar_cotacao()
